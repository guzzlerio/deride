...
- If `obj` is a function — delegates to [`func(fn)`](/api/func).
...
- [`stub`](/api/stub) — for objects you don't want to run real implementations against
- [`func`](/api/func) — for standalone functions
