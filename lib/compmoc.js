...
var Expectations = function(obj, method) {
    ...
    function toReturn(value) {
        ...
        if (argumentsPredicate !== null && argumentsPredicate !== undefined) {
            ...
            callToInvokeOnArguments[key] = overrideReturnValue;
        } else {
            callToInvoke = overrideReturnValue;
        }
...
function wrap(obj) {
    ...
    for (var i = 0; i < objMethods.length; i++) {
        ...
        expectMethods[method] = new Exp2(obj, method);
        setupMethods[method] = new Expectations(obj, method);
