...
// Support ES6 Classes.
// In pre ES6 (no `getOwnPropertyNames` and `getPrototypeOf`)
// just use normal iteration since they don't have classes with
// non-enumerable methods to begin with.
var getOwn = Object.getOwnPropertyNames || _.allKeys;
var getProto = Object.getPrototypeOf || _.constant(null);

function findComputedProperties(object) {
    var exclude = _.concat(getOwn(getProto(Object)), getOwn(getProto({})));
    var props = getOwn(getProto(object));
    props = _.concat(props, _.functionsIn(object));
    return _.uniq(_.filter(props, function(o){
        return exclude.indexOf(o) === -1;
    }));

}

function methods(obj) {
    return findComputedProperties(obj);
}
